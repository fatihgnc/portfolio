...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    about: {
      ...
      stack:
        'React, Next.js, TypeScript, Tailwind CSS, shadcn/ui, Zustand, Redux, RTK Query, React Query, Framer Motion, socket.io, chart.js, Node.js, Express, MongoDB, Supabase, Stripe, Resend, New Relic, Git, CI/CD, GitHub Actions, Storybook, Vitest, Jest, Docker, Claude Code, Cursor.',
    },
    projects: {
      h: 'Projects',
      intro:
